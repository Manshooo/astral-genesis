...
## Скорость полёта призрака, м/с — абсолютная, как и у тел (C_Walk.speed).
## Здесь, а не на компоненте: у БФЖ нет тела, которое дало бы ему характеристики,
## и он один на всю игру.
@export var ghost_speed: float = 4.0
