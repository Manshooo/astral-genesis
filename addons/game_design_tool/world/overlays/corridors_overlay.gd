...
##
## Схема, а не сами куски кита: кусок выбирается по маске проёмов, а маску
## здесь и показываем — ошибка раскладки (проём в стену, лишний стык) видна по
## рукавам, тогда как настоящий меш её только замаскировал бы.
@tool
extends Node3D
