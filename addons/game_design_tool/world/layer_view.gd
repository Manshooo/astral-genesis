...
## Куски коридора, которыми «Геометрия» застраивает тайлы плана — тот же кит, что
## у игры. null — коридоры в геометрии не ставятся (их план по-прежнему рисует
## оверлей «Коридоры»).
var kit: RS_CorridorKit
